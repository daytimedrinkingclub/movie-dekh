...
const PopcornBucket = ({ x, y, size, rotation }) => (
    <g transform={`translate(${x}, ${y}) rotate(${rotation})`}>
        <svg fill="#595858" height={size} width={size} version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" 
...
export default RandomPopcornBackground;